...
export class BaseJuegoVidaComponent implements OnInit {
  ...
  timeRefreshJuegoVida:number = 10;//5; //en milisegundos, velocidad del juego, cuanto menos más rapido
  numCelulas = 500;
  ...
  tableroAncho:number = Number((250*2).toFixed(0)); //height
  tableroAlto:number = 150*2;//nº de cubitos  width
